...
(async ()=>{
  ...
  const levels = ['w1l1','w1l2','w1l3','w1l4','w1l5','w2l1','w2l2','w2l3','w2l4','w2l5','w3l1','w3l2','w3l3','w3l4','w3l5','w4l1','w4l2','w4l3','w4l4','w4l5','w5l1','w5l2','w5l3','w5l4','w5l5','w6l1','w6l2','w6l3','w6l4','w6l5'];
  ...
  for(const [dist, area] of [['w1','boss1'],['w2','boss2'],['w3','boss3'],['w4','boss4'],['w5','boss5'],['w6','boss6']]){
