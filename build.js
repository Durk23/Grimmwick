...
'    var d=document.createElement("div"); d.style.cssText="font-size:11px;opacity:.7;margin-top:10px;max-width:80vw;word-break:break-word";',
'    d.textContent=String(e && e.message || e);  // a code error is not a WebGL failure — show it so device debugging is possible',
'    f.appendChild(d);}',
'}',
'</'+'script>',
'</body>',
